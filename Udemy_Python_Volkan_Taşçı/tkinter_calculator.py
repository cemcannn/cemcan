...
hesap_alani.grid(row=0, columnspan=5) # hesapalanı objesini 0. satırda 5 sütun birleşimlik alana yazdırır
...
buton_03 = Button(pencere, text = "3", command = lambda: alan_guncelle(str(1)))
